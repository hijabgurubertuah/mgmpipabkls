...
export const DEFAULT_FOLDER_NAME = '[MGMP IPA Bengkalis] Web Assets';
 ...
 * 5. Atur konfigurasi:
 *    - Description: "MGMP IPA Bengkalis Drive & Sheet API"
...
function doGet(e) {
  var output = {
    status: "success",
    message: "Google Apps Script Web App MGMP IPA Bengkalis aktif dan siap digunakan!",
...
function getOrCreateDefaultFolder() {
  var folderName = "[MGMP IPA Bengkalis] Web Assets";
