...
const SAMPLE_COMMENTS: CommentItem[] = [
  {
    ...
    userEmail: 'ahmad.faisal@guru.mgmp-ipa.org',
    userAvatar: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=100&auto=format&fit=crop&q=80',
    content: 'Alhamdulillah portal resmi MGMP IPA Kecamatan Bengkalis semakin informatif, bersih, dan mempermudah koordinasi guru-guru sains.',
  ...
  },
  {
    ...
    targetId: 'general',
    targetTitle: 'Halaman Utama Portal Resmi',
    userName: 'Rina Marlina, M.Pd (Guru IPA SMP)',
    ...
    content: 'Sangat terbantu dengan jadwal agenda musyawarah kerja dan modul praktikum IPA yang lengkap. Sukses selalu untuk komunitas MGMP IPA!',
