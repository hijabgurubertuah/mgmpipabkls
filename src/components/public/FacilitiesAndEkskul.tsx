...
export const FacilitiesAndEkskul: React.FC<FacilitiesAndEkskulProps> = ({
  facilities,
  extracurriculars,
  facilitiesTabTitle = 'Fasilitas & Sarana',
  ekskulTabTitle = 'Program & Kegiatan',
  facilitiesSectionTitle = 'Fasilitas & Program MGMP IPA',
  facilitiesSectionSubtitle = 'Sarana penunjang dan agenda kerja MGMP IPA Kecamatan Bengkalis dalam memajukan mutu pembelajaran sains.',
}) => {
