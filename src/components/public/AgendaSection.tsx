    ...
    <section id="agenda" className="py-16 sm:py-20 bg-white border-b border-slate-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-2xl mx-auto mb-12 space-y-3">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full badge-theme text-xs font-bold uppercase tracking-wider">
        ...
        {visibleAgendas.length === 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div
              key={item.id || idx}
              className="bg-slate-50 hover:bg-theme-light border border-slate-200/80 rounded-2xl p-6 transition-all duration-200 hover:shadow-md flex flex-col justify-between"
            >
              <div>
                <div className="flex items-center justify-between gap-2 mb-4">
                  <span className="inline-flex items-center gap-1 text-[11px] font-bold uppercase tracking-wider bg-white border border-slate-200 text-slate-700 px-2.5 py-1 rounded-md shadow-2xs">
                    <Tag className="w-3 h-3 text-theme-primary" />
                    {item.category}
                  </span>
                  <span className="text-xs font-bold badge-theme px-2 py-0.5 rounded">
                    Mendatang
                  </span>
                </div>
              ...
              <div className="space-y-2 pt-4 border-t border-slate-200/60 text-xs sm:text-sm text-slate-600">
                <div className="flex items-center gap-2">
                  <Calendar className="w-4 h-4 text-theme-primary shrink-0" />
