...
const SingleNewsModalView: React.FC<SingleNewsModalViewProps> = ({
  ...
  React.useEffect(() => {
    ...
    document.title = `${article.title} - MGMP IPA Kecamatan Bengkalis`;
      ...
      >
        ...
        <div className="flex items-center justify-between p-4 sm:p-5 border-b border-slate-100 bg-slate-50/90 shrink-0">
          <div className="flex flex-wrap items-center gap-2">
            <span className="badge-theme inline-flex items-center gap-1 text-xs font-bold uppercase tracking-wider px-2.5 py-1 rounded-md">
          ...
          <div className="flex items-center gap-2">
            {parsedEmbed && (
              <a
                ...
                className="hidden sm:inline-flex items-center gap-1.5 px-3 py-1.5 bg-theme-light text-theme-primary border border-[var(--theme-primary)]/20 rounded-lg text-xs font-bold transition-colors"
              >
            ...
            <button
              ...
              className="p-2 text-slate-500 hover:text-theme-primary hover:bg-slate-200/60 rounded-lg transition-colors cursor-pointer"
            >
        ...
        <div className="p-3.5 sm:p-8 overflow-y-auto overscroll-contain touch-pan-y space-y-4 sm:space-y-6 flex-1 pb-6 sm:pb-8">
          ...
          {article.actionLink && article.actionLink.url && (
            <div className="p-4 sm:p-5 rounded-xl border border-slate-200 bg-gradient-to-r from-slate-50 to-slate-100/60 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              ...
              <button
                ...
                className="btn-theme-primary inline-flex items-center justify-center gap-2 px-5 py-2.5 font-bold text-xs sm:text-sm rounded-xl shadow-sm hover:shadow transition-all shrink-0 cursor-pointer"
              >
              ...
              <div className="px-4 py-3 bg-slate-900 text-white flex flex-wrap items-center justify-between gap-3 border-b border-slate-800">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="btn-theme-primary inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-bold transition-all shadow-sm cursor-pointer"
                  >
                    <ExternalLink className="w-3.5 h-3.5" />
        ...
        <div className="p-3.5 sm:p-4 border-t border-slate-100 bg-slate-50 flex items-center justify-between gap-3 shrink-0">
          ...
          <div className="flex items-center gap-2 shrink-0">
            ...
            <button
              type="button"
              onClick={onClose}
              className="btn-theme-primary px-4 sm:px-5 py-2 text-xs font-bold rounded-lg transition-colors cursor-pointer shadow-xs"
            >
              Tutup
            </button>
          </div>
          ...
          >
            ...
            >
              <div className="flex items-start gap-4">
                <div className="p-3 bg-theme-light text-theme-primary rounded-xl shrink-0">
              ...
              <div className="p-3.5 bg-slate-50 border border-slate-200 rounded-xl flex items-center gap-2.5 overflow-hidden">
                <Globe className="w-4 h-4 text-theme-primary shrink-0" />
              ...
              <div className="pt-2 flex items-center justify-end gap-2.5">
                ...
                <button
                  ...
                  className="btn-theme-primary px-5 py-2.5 rounded-xl font-bold text-xs sm:text-sm shadow-md transition-all cursor-pointer flex items-center gap-1.5"
                >
                  <span>Buka Link</span>
                  <ExternalLink className="w-3.5 h-3.5" />
                </button>
